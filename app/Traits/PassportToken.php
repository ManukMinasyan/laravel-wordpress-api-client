...
trait PassportToken
{
    ...
    protected function createPassportTokenByUser(UserOld $user, $clientId)
    {
    ...
    /**
     * @param \App\Models\UserOld $user
     * @param $clientId
     * @param bool                $output default = true
     *
     * @return array | \League\OAuth2\Server\ResponseTypes\BearerTokenResponse
     */
    protected function getBearerTokenByUser(UserOld $user, $clientId, $output = true)
    {
